...
params4 <-  roleParams(individuals_local = 100, individuals_meta = 1000, 
                       ...
                       comp_sigma = .05, dispersal_prob = function(iter){return(ifelse(iter < 5000, .5, ifelse(iter < 6000, .25, .001)))}) 



paramsList4 <- list(params4, params4, params4, params4, params4)
...
a_model_pulse <- results4@modelRuns[[4]]
